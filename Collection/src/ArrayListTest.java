...
public class ArrayListTest {
	...
	public static void main(String[] args) {
		...
		PhoneLog log1 = new PhoneLog("You missed a call", LocalDate.now(), "Missed", "Riya");
		PhoneLog log2 = new PhoneLog("You dialed a call", LocalDate.now(), "Dialed", "Aditya");
		PhoneLog log3 = new PhoneLog("You recieved a call", LocalDate.now(), "Recieved", "Mansi");
		PhoneLog log4 = new PhoneLog("You got a sms", LocalDate.now(), "Message In", "Harsh");
		PhoneLog log5 = new PhoneLog("You missed a call", LocalDate.now(), "Missed", "Aniket");
